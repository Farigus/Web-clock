...
case 1:
    dateInfo.innerText = 'Today is '  + month + ' the ' + day + 'st of the ' + year + ' year!';
break;
case 2:
    dateInfo.innerText = 'Today is '  + month + ' the ' + day + 'nd of the ' + year + ' year!';
    break;
case 3:
    dateInfo.innerText = 'Today is '  + month + ' the ' + day + 'rd of the ' + year + ' year!';
break;
default:
    dateInfo.innerText = 'Today is '  + month + ' the ' + day + 'th of the ' + year + ' year!';
    break;
